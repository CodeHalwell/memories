...
pub const SCENE_DESCRIPTION_SYSTEM: &str = r#"You generate abstract, impressionistic scene descriptions for memories.
...
pub const SAVE_DECISION_SYSTEM: &str = r#"You are a memory curator for an AI agent. Your job is to decide whether
...
pub const MERGE_SYSTEM: &str = r#"You are a memory compaction agent. You merge multiple related episodic memories
...
pub const SYNTHETIC_QUERY_SYSTEM: &str = r#"Generate search queries that would retrieve the given memory content.
...
pub const EMOTION_SYSTEM: &str = r#"You are an emotional context analyser. Score the emotional tone of the given text.
...
pub const CLASSIFY_RELATIONSHIP_SYSTEM: &str = r#"Classify the relationship between two memories.
