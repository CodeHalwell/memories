...
/// <summary>System prompt constants used by LLM-driven memory operations.</summary>
public static class Prompts
{
    public const string SceneDescriptionSystem =
        """
        You generate abstract, impressionistic scene descriptions for memories.
    ...
    public const string SaveDecisionSystem =
        """
        You are a memory curator for an AI agent. Your job is to decide whether
    ...
    public const string MergeSystem =
        """
        You are a memory compaction agent. You merge multiple related episodic memories
    ...
    public const string SyntheticQuerySystem =
        """
        Generate search queries that would retrieve the given memory content.
    ...
    public const string EmotionSystem =
        """
        You are an emotional context analyser. Score the emotional tone of the given text.
    ...
    public const string ClassifyRelationshipSystem =
        """
